...
def get_columns(filters: Filters) -> list[dict]:
	...
	if filters.summarized_view:
		...
		columns.extend([
			{"label": _("Present - P"), "fieldname": "count_p", "fieldtype": "Int", "width": 110},
			{"label": _("Absent - A"), "fieldname": "count_a", "fieldtype": "Int", "width": 110},
			{"label": _("Half Day - HD"), "fieldname": "count_hd", "fieldtype": "Int", "width": 120},
			{"label": _("Work From Home - WFH"), "fieldname": "count_wfh", "fieldtype": "Int", "width": 120},
			{"label": _("On Leave - L"), "fieldname": "count_l", "fieldtype": "Int", "width": 110},
			{"label": _("Holiday - H"), "fieldname": "count_h", "fieldtype": "Int", "width": 110},
			{"label": _("Weekly Off - WO"), "fieldname": "count_wo", "fieldtype": "Float", "width": 120},
		])
...
def get_attendance_status_for_detailed_view(
	...
	for shift, status_dict in employee_attendance.items():
		...
		for day in range(1, total_days + 1):
			...
			if abbr in count_map:
				count_map[abbr] += 1

		row.update({
			"count_p": count_map["P"],
			"count_a": count_map["A"],
			"count_hd": count_map["HD"],
			"count_wfh": count_map["WFH"],
			"count_l": count_map["L"],
			"count_h": count_map["H"],
			"count_wo": count_map["WO"],
		})
